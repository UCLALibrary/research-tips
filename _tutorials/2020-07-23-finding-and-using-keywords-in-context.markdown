...
<div class="row">
    ...
    <div class="col-sm-12 col-md-7">
        <p class="card-text">Language changes over time and groups of people may refer to the same thing using different words. Learn how to use a variety of keywords when searching for resources!</p>
            <a href="https://drive.google.com/file/d/1cRcxhwAXuvrnxJid9Hk2HpCoS2OzzWnk/view?usp=sharing" target="_blank" class="btn btn-outline-primary btn-block" aria-label="Open the guide in new window">Finding and Using Keywords in Context <i class="fas fa-external-link-alt" aria-hidden="true"></i></a>
    </div>
</div>
