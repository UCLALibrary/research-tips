...
<p>The language we use matters. The terms misinformation and disinformation are not always interchangeable and each come with their own set of implications about the intent of the sharer, the information’s level of veracity and factuality (or lack thereof), and the reliability of the source. The learning activity below helps learners define these terms and practice spotting examples.</p> 
