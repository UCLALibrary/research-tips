...
<!-- Maybe here in the "diagram" space we can put 3 cool things you can do with Zotero with just text and images? -->
  ...
  <div class="row">
   ...
   <div class="col s12 m4">
      <div class="card">
        <div class="card-image">
          <img src="https://www.evernote.com/l/AN9k1FX-_nRDJZ6Iz1vqF_LtFo_jD1j_sC4B/image.png" alt="Zotero's plug-in for word allows you to create citations while writing a paper.">
        </div>
        <div class="card-content">
