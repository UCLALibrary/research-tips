...
<!-- Maybe here in the "diagram" space we can put 3 cool things you can do with Zotero with just text and images? -->
  ...
  <div class="row">
   ...
   <div class="col s12 m4">
      <div class="card">
        <div class="card-image">
          <img src="https://www.evernote.com/l/AN90Y39KZKtBppT-51SD_4VPrZokfnAjamUB/image.png" alt="Zotero's plug-in for word allows you to create citations while writing a paper.">
        </div>
        <div class="card-content">
    ...
    <div class="col s12 m4">
      <div class="card">
        <div class="card-image">
          <img src="https://www.evernote.com/l/AN9ofhgS_rxB_o_EKsusvT_PPd2cCsR22XYB/image.png" alt="Make a biblography with copy and paste.">
        </div>
        <div class="card-content">
