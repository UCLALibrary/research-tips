    ...
    <div class="collapsible-body">
        <div class="row">
            <div class="col s12 m8">
                ...
                <ul class="browser_default"><li>Gauge the quantity of reading and the time you have to read it.</li>
    ...
    <div class="collapsible-body">
        <div class="row">
            <div class="col s12 m8">
                ...
                <ul class="browser_default"><li>Ask yourself, “How will I be asked to demonstrate my knowledge of the text?”</li>
    ...
    <div class="collapsible-body">
        <div class="row">
            <div class="col s12 m8">
                ...
                <ul class="browser_default"><li>Whenever you encounter an important concept, paraphrase it in the margins or on a separate paper.</li>
