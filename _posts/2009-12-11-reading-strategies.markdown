    ...
    <div class="collapsible-body">
        <div class="row">
            <div class="col s12 m4">
                ...
                <ul><li>Gauge the quantity of reading and the time you have to read it.</li>
    ...
    <div class="collapsible-body">
        <div class="row">
            <div class="col s12 m4">
                ...
                <ul><li>Ask yourself, “How will I be asked to demonstrate my knowledge of the text?”</li>
