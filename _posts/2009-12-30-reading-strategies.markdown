...
<div class="card col s12 m6">
    ...
    <div class="card-content activator"> <span class="card-title activator grey-text text-darken-4">Plan your Reading Session
        </span><a class="btn-small halfway-fab waves-effect waves-light blue activator"><i class="material-icons left">more_vert</i>Details</a>
    </div>
