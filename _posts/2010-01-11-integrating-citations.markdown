...
### Specific Citation Strategies:
  ...
  <ul class="collapsible" data-collapsible="expandable">
   <li>
      ...
      <p class="two"><div style='background:white;' class="col s12 m5;m8"><font size="4"><p><markgreen>The studies of Newman and Kenworthy</markgreen> (<markyellow>1989, 1999</markyellow>) <markgreen>demonstrate a negative relationship between population density and transportation fuel use</markgreen>.</p></font>
      </div></p>
