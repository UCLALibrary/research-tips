...
At the same time, we were inspired by discussions with WI+RE Community members Marisa Méndez-Brady and Renee Romero to think about how the new site could celebrate the many contributions of our community members to each project. 
