...
b.viewportWidth=function(){return document.documentElement.clientWidth};b.adapters=[];b.defaults={context:GLOBAL_window,continuous:JSCompiler_alias_TRUE,enabled:JSCompiler_alias_TRUE,group:$$S_default,horizontal:JSCompiler_alias_FALSE,offset:0};b.offsetAliases={"bottom-in-view":function(){return this.context[$$PROP_innerHeight]()-this.adapter.outerHeight()},"right-in-view":function(){return this.context[$$PROP_innerWidth]()-this.adapter.outerWidth()}};GLOBAL_window.HYPE_w_584=b})();
...
(function(){function b(){}function d(c){this.options=a.Adapter.extend({},d.defaults,c);this.axis=this[$$PROP_options].horizontal?$$S_horizontal:$$S_vertical;this.waypoints=[];this.createWaypoints()}var a=GLOBAL_window.HYPE_w_584;d[$$PROP_prototype].createWaypoints=function(){for(var a=this,b={vertical:[{down:$$S_enter,up:$$S_noop,offset:function(){return this.context[$$PROP_innerHeight]()-a[$$PROP_options].elementOffset}},{down:$$S_noop,up:$$S_exit,offset:function(){return this.context[$$PROP_innerHeight]()}},
...
(function(){var b=[];GLOBAL_window.HYPE_wdtl_584!=JSCompiler_alias_NULL&&(b=GLOBAL_window.HYPE_wdtl_584.slice(0));GLOBAL_window.HYPE_wdtl_584=JSCompiler_alias_NULL;for(var d=0;d<b[$$PROP_length];d++)b[d]()})();})();
